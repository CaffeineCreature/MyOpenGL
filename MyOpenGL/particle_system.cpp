...
bool ParticleSystem::InitParticleSystem(const Vector3f& Pos)
{
	...
	Particles[0].Pos = Pos;
	Particles[0].Vel = Vector3f(0.0f, 0.000001f, 0.0f);
	...
	m_updateTechnique.SetShellLifetime(100000.0f);
	...
	m_pTexture = new Texture(GL_TEXTURE_2D, "../Content/ParticleAlphaTest.png");
