					   ...
					   vec3 Specular)
{
    ...
    if (DiffuseFactor > 0.0) {
        ...
        if (SpecularFactor > 0.0) {
            ...
            SpecularColor = vec4(Light.Color * Specular * SpecularFactor, 1.0);
        }
    }
...
vec4 CalcDirectionalLight(vec3 WorldPos, vec3 Normal, vec3 Specular)
{
...
vec4 CalcPointLight(vec3 WorldPos, vec3 Normal, vec3 Specular)
{
...
void main()
{
	...
	vec3 Specular = texture(gSpecularMap, TexCoord).xyz;
